...
# https://stackoverflow.com/questions/41626129/how-do-i-get-the-update-history-from-windows-update-in-powershell
# foreach-object with: if ($_.Title -notlike "Definition Update*")
